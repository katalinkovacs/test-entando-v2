...
public class AttendeeListTag extends TagSupport {

	private static final Logger _logger =  LoggerFactory.getLogger(AttendeeListTag.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			*/
			List<Integer> list = attendeeManager.getAttendees();
			this.pageContext.setAttribute(this.getVar(), list);
		} catch (Throwable t) {
			_logger.error("Error in doStartTag", t);
			throw new JspException("Error in AttendeeListTag doStartTag", t);
		}
